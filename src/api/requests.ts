...
export const login = (payload: any) => request.post(urls.signup, payload);
export const variations = () => request.get(urls.variations);
export const books = () => request.get(urls.books);

export const addBook = (payload: any) => request.post(urls.books, payload);
export const editBook = ({ id, payload }: { id: number; payload: any }) =>
